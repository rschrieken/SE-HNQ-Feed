  ...
  function getChatrooms(){
    function getChatroomsInternal(resolve, reject) {
      ...
      chatrooms = [
        ...
        {server: se, url:'https://chat.stackexchange.com/rooms/109935?tab=feeds', name:'HOT Network Questions 🔥'},
        {server: se, url:'https://chat.stackexchange.com/rooms/info/108277/testing-bounties?tab=feeds', name:'Testing Bounties'},
        
        {server: se, url:'https://chat.stackexchange.com/rooms/107719?tab=feeds', name:'Hot Network Questions Feed (Drones)'},
        {server: se, url:'https://chat.stackexchange.com/rooms/98630?tab=feeds', name:'Hot Network Questions Feed (Travel)'},
